...
for i in `seq 0 99`
do
    echo "create table order_deal_history_$i"
    mysql -h$MYSQL_HOST -u$MYSQL_USER -p$MYSQL_PASS $MYSQL_DB -e "CREATE TABLE order_deal_history_$i LIKE order_deal_history_example;"
done
